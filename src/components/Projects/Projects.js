...
const testimonials = [
  {
    ...
    info: "Fan Made Web App for two series 1. Breaking Bad 2. Better Call Saul. This app let's you see the character info, famous quotes and much more.",
  },
  {
    title: "Chat Room",
...
function Project() {
  ...
  useEffect(() => {
    ...
    console.log(imageWidth, "Here in");
    return () => {
